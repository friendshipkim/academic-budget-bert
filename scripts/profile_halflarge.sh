# Script to profile a half-large model
# bash script/profile_halflarge.sh > profiles/halflarge.log
# NOTE: make sure to use the same train_micro_batch_size_per_gpu
# and dataset_path for all models
